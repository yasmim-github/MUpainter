#NOTE-TO-SELF: the best software layout should be something like this
# QHboxlayout (pallette. brush size)
# pixmap       
...
from PyQt6.QtGui import QPainter, QColor, QMouseEvent, QPen, QPixmap, QIcon
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        mainmenu = QHBoxLayout(mainmenu_widget)
        mainlayout.addWidget(mainmenu_widget)
        
        self.wks = Workspace() 
        self.mu = MUcolorwheel(self.wks)
        self.szt = setSizeToggle(self.wks) 
        
        mainmenu.addWidget(self.mu, stretch=1)
        mainmenu.addWidget(self.szt, stretch=1)
        mainlayout.addWidget(self.wks, stretch=4) 
...
class setSizeToggle(QWidget):
    def __init__(self,workspace):
        ...
        self.sizes = QHBoxLayout()
        self.add_pensize_toggle(self.sizes)
        self.lay = QHBoxLayout()
        self.lay.addLayout(self.sizes)
...
class MUcolorwheel(QWidget):
    def __init__(self, workspace):
        ...
        self.color_button = QPushButton(icon=QIcon("./colorwheel.svg"),text="ColorWheel")
